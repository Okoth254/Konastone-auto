                ...
                <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
                    {[
                        ...
                        <motion.div
                            ...
                            className="bg-surface-dark/40 backdrop-blur-xl p-5 sm:p-6 lg:p-8 rounded-[2.5rem] border border-white/5 group hover:border-white/20 transition-all duration-500"
                        >
                            ...
                            <tbody className="text-sm">
                                {[
                                    ...
                                    <tr key={row.label} className="border-b border-white/5 hover:bg-white/2 transition-colors group">
                                        ...
                                        <td className="px-5 py-4 lg:px-10 lg:py-6 text-white font-mono font-black tracking-widest group-hover:text-primary transition-colors">{row.value}</td>
                                        <td className="px-5 py-4 lg:px-10 lg:py-6 text-right">
