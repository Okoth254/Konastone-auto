                ...
                {isMobileMenuOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed inset-0 z-50 md:hidden bg-white/95 dark:bg-header-dark/95 backdrop-blur-2xl pt-24"
                        >
                            <div className="flex flex-col gap-4 p-6 overflow-y-auto h-full">
                                {[
                                    ...
                                    >
                                        <Link href={link.href} onClick={closeMenu} className={`block text-3xl font-heading tracking-wider py-4 border-b border-gray-200/70 dark:border-gray-800/80 ${pathname === link.href ? 'text-primary' : 'text-gray-900 dark:text-white'}`}>
                                            {link.name}
                                        </Link>
                                    </motion.div>
                                ))}
